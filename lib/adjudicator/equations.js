...
move = function (order) {
    ...
    if (!order.h2h) {
        ...
        if (order_attack_strength[0] > opposing_hold_strength[1]) {
            ...
            _.each(order.relevancies, function (other_order) {
    ...
    // In a h2h conflict ...
        ...
        if (order_attack_strength[0] > opposing_defend_strength[1]) {
            ...
            _.each(order_list.relevancies, function (other_order) {
...
support = function (order) {
    ...
    // If partner has failed in their order ...
...
attack_strength = function (order) {
    ...
    var countSupports = function (order) {
        min++;
        max++;
