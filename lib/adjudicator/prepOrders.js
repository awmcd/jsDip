...
define(["underscore", "util/translateOrders",
        "util/trueAdjacency", "util/getConvoyPaths", "util/getConvoyLegality"],
        function (_, translateOrders, trueAdjacency, getConvoyPaths, getConvoyLegality) {
...
function prepOrders (game, state, order_list) {
    ...
    // Gotta label illegal convoys early in process
    ...
    _.each(order_list, function (order) {
        ...
        if (order.unit.type === 'a' &&
            ...
            if (order.convoy_explicit) {
                ...
                console.log('Explit convoy paths', convoyPaths)
