...
equations
---------
Contains equations for all the major game actions and backup rules for paradoxes.

For conceptual overview, see Lucas Kruijswijk's excellent article, "The Math of
Adjudication," especially Chapters 2 and 4.
...
path = function (order) {
    ...
    if (order.type === 'move') {
        ...
        if (geo_check && !order.convoy_dependant) {
            return true;
